...
| 2026-06-13 | phase4-picking-v2.1 | Final architecture: base_channels=16, embed_dim=64, dropout=0.5 (~2.3M params). Added expected-value frequency-axis smoothness loss (weight=0.05). Disabled pick-synchronized shifts (too strong for 150 training spectra). Added min_val_coverage safeguard for checkpoint selection. Best run: base16-drop0.5, best val RMSE=3.59 px, smoothed=4.33 px, val F1=0.927, no mode jumps. | v2: best val RMSE=6.73 px, smoothed=6.93 px, F1=0.921 | best val RMSE=3.59 px, smoothed=4.33 px, F1=0.927 | val RMSE=-3.14 px, smoothed=-2.60 px, F1=+0.006 |
